    ...
    val scn = scenario("Test the Activity entity")
        ...
        .repeat(2) {
            ...
            .body(StringBody("""{
                ...
                , "successText":"SAMPLE_TEXT"
                , "failureText":"SAMPLE_TEXT"
                , "skipText":"SAMPLE_TEXT"
                , "challengeName":"STRONG"
                , "difficulty":"LOW"
                , "prizeNumber":"SAMPLE_TEXT"
                , "challangeRating":"SAMPLE_TEXT"
                , "sacrificeNumber":"SAMPLE_TEXT"
                , "skipResult":"SAMPLE_TEXT"
                }""")).asJson
            .check(status.is(201))
