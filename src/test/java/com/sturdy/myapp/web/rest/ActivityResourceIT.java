...
class ActivityResourceIT {
    ...
    private static final Choice DEFAULT_TYPE_CHALLENGE = Choice.MOVE;
    private static final Choice UPDATED_TYPE_CHALLENGE = Choice.PLAY;
    ...
    private static final Difficulty DEFAULT_CHALLANGE_RATING = Difficulty.LOW;
    private static final Difficulty UPDATED_CHALLANGE_RATING = Difficulty.MEDIUM;
    ...
    public static Activity createEntity(EntityManager em) {
        Activity activity = new Activity()
            ...
            .typeChallenge(DEFAULT_TYPE_CHALLENGE)
    ...
    public static Activity createUpdatedEntity(EntityManager em) {
        Activity activity = new Activity()
            ...
            .typeChallenge(UPDATED_TYPE_CHALLENGE)
    ...
    void createActivity() throws Exception {
        ...
        assertThat(testActivity.getTypeChallenge()).isEqualTo(DEFAULT_TYPE_CHALLENGE);
    ...
    void getAllActivities() throws Exception {
        ...
        restActivityMockMvc
            ...
            .andExpect(jsonPath("$.[*].typeChallenge").value(hasItem(DEFAULT_TYPE_CHALLENGE.toString())))
            ...
            .andExpect(jsonPath("$.[*].challangeRating").value(hasItem(DEFAULT_CHALLANGE_RATING.toString())))
    ...
    void getActivity() throws Exception {
        ...
        restActivityMockMvc
            ...
            .andExpect(jsonPath("$.typeChallenge").value(DEFAULT_TYPE_CHALLENGE.toString()))
            ...
            .andExpect(jsonPath("$.challangeRating").value(DEFAULT_CHALLANGE_RATING.toString()))
    ...
    void putExistingActivity() throws Exception {
        ...
        assertThat(testActivity.getTypeChallenge()).isEqualTo(UPDATED_TYPE_CHALLENGE);
