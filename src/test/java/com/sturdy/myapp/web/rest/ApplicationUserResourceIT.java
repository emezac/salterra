...
class ApplicationUserResourceIT {
    ...
    private static final String DEFAULT_POLYGON_ADDRESS = "AAAAAAAAAA";
    private static final String UPDATED_POLYGON_ADDRESS = "BBBBBBBBBB";

    private static final String DEFAULT_PUBLIC_URL = "AAAAAAAAAA";
    private static final String UPDATED_PUBLIC_URL = "BBBBBBBBBB";
    ...
    public static ApplicationUser createEntity(EntityManager em) {
        ApplicationUser applicationUser = new ApplicationUser()
            ...
            .role(DEFAULT_ROLE)
            .polygonAddress(DEFAULT_POLYGON_ADDRESS)
    ...
    public static ApplicationUser createUpdatedEntity(EntityManager em) {
        ApplicationUser applicationUser = new ApplicationUser()
            ...
            .role(UPDATED_ROLE)
            .polygonAddress(UPDATED_POLYGON_ADDRESS)
    ...
    void createApplicationUser() throws Exception {
        ...
        assertThat(testApplicationUser.getPolygonAddress()).isEqualTo(DEFAULT_POLYGON_ADDRESS);
        assertThat(testApplicationUser.getPublicUrl()).isEqualTo(DEFAULT_PUBLIC_URL);
    }
    ...
    void getAllApplicationUsers() throws Exception {
        ...
        restApplicationUserMockMvc
            ...
            .andExpect(jsonPath("$.[*].polygonAddress").value(hasItem(DEFAULT_POLYGON_ADDRESS)))
            .andExpect(jsonPath("$.[*].publicUrl").value(hasItem(DEFAULT_PUBLIC_URL)));
    }
    ...
    void getApplicationUser() throws Exception {
        ...
        restApplicationUserMockMvc
            ...
            .andExpect(jsonPath("$.polygonAddress").value(DEFAULT_POLYGON_ADDRESS))
            .andExpect(jsonPath("$.publicUrl").value(DEFAULT_PUBLIC_URL));
    }
    ...
    void putExistingApplicationUser() throws Exception {
        ...
        assertThat(testApplicationUser.getPolygonAddress()).isEqualTo(UPDATED_POLYGON_ADDRESS);
        assertThat(testApplicationUser.getPublicUrl()).isEqualTo(UPDATED_PUBLIC_URL);
    }
    ...
    void partialUpdateApplicationUserWithPatch() throws Exception {
        ...
        partialUpdatedApplicationUser.email(UPDATED_EMAIL).password(UPDATED_PASSWORD);
