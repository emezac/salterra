...
class PrizePoolResourceIT {
    ...
    private static final String DEFAULT_POOL_NAME = "AAAAAAAAAA";
    private static final String UPDATED_POOL_NAME = "BBBBBBBBBB";
    ...
    public static PrizePool createEntity(EntityManager em) {
        PrizePool prizePool = new PrizePool().poolName(DEFAULT_POOL_NAME);
        return prizePool;
    }
    ...
    public static PrizePool createUpdatedEntity(EntityManager em) {
        PrizePool prizePool = new PrizePool().poolName(UPDATED_POOL_NAME);
        return prizePool;
    }
    ...
    void createPrizePool() throws Exception {
        ...
        assertThat(testPrizePool.getPoolName()).isEqualTo(DEFAULT_POOL_NAME);
    }
    ...
    void getAllPrizePools() throws Exception {
        ...
        restPrizePoolMockMvc
            ...
            .andExpect(jsonPath("$.[*].poolName").value(hasItem(DEFAULT_POOL_NAME)));
    }
    ...
    void getPrizePool() throws Exception {
        ...
        restPrizePoolMockMvc
            ...
            .andExpect(jsonPath("$.poolName").value(DEFAULT_POOL_NAME));
    }
    ...
    void putExistingPrizePool() throws Exception {
        ...
        updatedPrizePool.poolName(UPDATED_POOL_NAME);
        ...
        PrizePool testPrizePool = prizePoolList.get(prizePoolList.size() - 1);
        assertThat(testPrizePool.getPoolName()).isEqualTo(UPDATED_POOL_NAME);
    }
    ...
    void fullUpdatePrizePoolWithPatch() throws Exception {
        ...
        partialUpdatedPrizePool.poolName(UPDATED_POOL_NAME);
