...
class FloorRoomsResourceIT {
    ...
    public static FloorRooms createEntity(EntityManager em) {
        FloorRooms floorRooms = new FloorRooms().floorId(DEFAULT_FLOOR_ID).roomId(DEFAULT_ROOM_ID);
        return floorRooms;
    }
    ...
    public static FloorRooms createUpdatedEntity(EntityManager em) {
        FloorRooms floorRooms = new FloorRooms().floorId(UPDATED_FLOOR_ID).roomId(UPDATED_ROOM_ID);
        return floorRooms;
    }
    ...
    void createFloorRooms() throws Exception {
        ...
        assertThat(testFloorRooms.getFloorId()).isEqualTo(DEFAULT_FLOOR_ID);
        assertThat(testFloorRooms.getRoomId()).isEqualTo(DEFAULT_ROOM_ID);
    }
    ...
    void putExistingFloorRooms() throws Exception {
        ...
        updatedFloorRooms.floorId(UPDATED_FLOOR_ID).roomId(UPDATED_ROOM_ID);
        ...
        FloorRooms testFloorRooms = floorRoomsList.get(floorRoomsList.size() - 1);
        assertThat(testFloorRooms.getFloorId()).isEqualTo(UPDATED_FLOOR_ID);
        assertThat(testFloorRooms.getRoomId()).isEqualTo(UPDATED_ROOM_ID);
    }
    ...
    void partialUpdateFloorRoomsWithPatch() throws Exception {
        ...
        partialUpdatedFloorRooms.floorId(UPDATED_FLOOR_ID).roomId(UPDATED_ROOM_ID);
