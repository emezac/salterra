...
class DungeonFloorsResourceIT {
    ...
    public static DungeonFloors createEntity(EntityManager em) {
        DungeonFloors dungeonFloors = new DungeonFloors().dgId(DEFAULT_DG_ID).floorId(DEFAULT_FLOOR_ID);
    ...
    public static DungeonFloors createUpdatedEntity(EntityManager em) {
        DungeonFloors dungeonFloors = new DungeonFloors().dgId(UPDATED_DG_ID).floorId(UPDATED_FLOOR_ID);
        return dungeonFloors;
    }
    ...
    void createDungeonFloors() throws Exception {
        ...
        assertThat(testDungeonFloors.getFloorId()).isEqualTo(DEFAULT_FLOOR_ID);
    }
    ...
    void putExistingDungeonFloors() throws Exception {
        ...
        updatedDungeonFloors.dgId(UPDATED_DG_ID).floorId(UPDATED_FLOOR_ID);
        ...
        assertThat(testDungeonFloors.getFloorId()).isEqualTo(UPDATED_FLOOR_ID);
    }
    ...
    void fullUpdateDungeonFloorsWithPatch() throws Exception {
        ...
        partialUpdatedDungeonFloors.dgId(UPDATED_DG_ID).floorId(UPDATED_FLOOR_ID);
