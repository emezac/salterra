...
class PrizeResourceIT {
    ...
    public static Prize createEntity(EntityManager em) {
        Prize prize = new Prize().description(DEFAULT_DESCRIPTION);
        return prize;
    }
    ...
    public static Prize createUpdatedEntity(EntityManager em) {
        Prize prize = new Prize().description(UPDATED_DESCRIPTION);
        return prize;
    }
    ...
    void putExistingPrize() throws Exception {
        ...
        updatedPrize.description(UPDATED_DESCRIPTION);
    ...
    void partialUpdatePrizeWithPatch() throws Exception {
        ...
        partialUpdatedPrize.description(UPDATED_DESCRIPTION);
