...
class RoomResourceIT {
    ...
    private static final Integer DEFAULT_GATEWAY_DOOR = 1;
    private static final Integer UPDATED_GATEWAY_DOOR = 2;
    ...
    public static Room createEntity(EntityManager em) {
        Room room = new Room().introText(DEFAULT_INTRO_TEXT).haveGatewayDoor(DEFAULT_HAVE_GATEWAY_DOOR).gatewayDoor(DEFAULT_GATEWAY_DOOR);
        return room;
    }
    ...
    public static Room createUpdatedEntity(EntityManager em) {
        Room room = new Room().introText(UPDATED_INTRO_TEXT).haveGatewayDoor(UPDATED_HAVE_GATEWAY_DOOR).gatewayDoor(UPDATED_GATEWAY_DOOR);
        return room;
    }
    ...
    void createRoom() throws Exception {
        ...
        assertThat(testRoom.getGatewayDoor()).isEqualTo(DEFAULT_GATEWAY_DOOR);
    }
    ...
    void getAllRooms() throws Exception {
        ...
        restRoomMockMvc
            ...
            .andExpect(jsonPath("$.[*].gatewayDoor").value(hasItem(DEFAULT_GATEWAY_DOOR)));
    }
    ...
    void getRoom() throws Exception {
        ...
        restRoomMockMvc
            ...
            .andExpect(jsonPath("$.gatewayDoor").value(DEFAULT_GATEWAY_DOOR));
    }
    ...
    void putExistingRoom() throws Exception {
        ...
        updatedRoom.introText(UPDATED_INTRO_TEXT).haveGatewayDoor(UPDATED_HAVE_GATEWAY_DOOR).gatewayDoor(UPDATED_GATEWAY_DOOR);
        ...
        assertThat(testRoom.getGatewayDoor()).isEqualTo(UPDATED_GATEWAY_DOOR);
    }
    ...
    void partialUpdateRoomWithPatch() throws Exception {
        ...
        partialUpdatedRoom.haveGatewayDoor(UPDATED_HAVE_GATEWAY_DOOR).gatewayDoor(UPDATED_GATEWAY_DOOR);
    ...
    void fullUpdateRoomWithPatch() throws Exception {
        ...
        partialUpdatedRoom.introText(UPDATED_INTRO_TEXT).haveGatewayDoor(UPDATED_HAVE_GATEWAY_DOOR).gatewayDoor(UPDATED_GATEWAY_DOOR);
