...
public class Choice implements Serializable {
    ...
    @JsonIgnoreProperties(value = { "choice" }, allowSetters = true)
    ...
    public void setOptions(Set<Option> options) {
        if (this.options != null) {
            this.options.forEach(i -> i.setChoice(null));
        }
        if (options != null) {
            options.forEach(i -> i.setChoice(this));
        }
    ...
    public Choice activity(Activity activity) {
