...
public class Challenge implements Serializable {
    ...
    @ManyToMany
    @JoinTable(
        name = "rel_challenge__challenge",
        joinColumns = @JoinColumn(name = "challenge_id"),
        inverseJoinColumns = @JoinColumn(name = "challenge_id")
    )
    @JsonIgnoreProperties(value = { "move", "moves" }, allowSetters = true)
    private Set<Move> challenges = new HashSet<>();
    ...
    public Set<Move> getChallenges() {
        return this.challenges;
    }

    public void setChallenges(Set<Move> moves) {
        this.challenges = moves;
    }

    public Challenge challenges(Set<Move> moves) {
        this.setChallenges(moves);
        return this;
    }

    public Challenge addChallenge(Move move) {
        this.challenges.add(move);
        move.getMoves().add(this);
        return this;
    }

    public Challenge removeChallenge(Move move) {
        this.challenges.remove(move);
        move.getMoves().remove(this);
        return this;
    }
