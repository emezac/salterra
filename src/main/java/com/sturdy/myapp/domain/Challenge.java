...
public class Challenge implements Serializable {
    ...
    @OneToMany(mappedBy = "challenge")
    @JsonIgnoreProperties(value = { "challenge", "move" }, allowSetters = true)
    private Set<ChallengeMoves> challengeMoves = new HashSet<>();
    ...
    public Set<ChallengeMoves> getChallengeMoves() {
        return this.challengeMoves;
    }

    public void setChallengeMoves(Set<ChallengeMoves> challengeMoves) {
        if (this.challengeMoves != null) {
            this.challengeMoves.forEach(i -> i.setChallenge(null));
        }
        if (challengeMoves != null) {
            challengeMoves.forEach(i -> i.setChallenge(this));
        }
        this.challengeMoves = challengeMoves;
    }

    public Challenge challengeMoves(Set<ChallengeMoves> challengeMoves) {
        this.setChallengeMoves(challengeMoves);
        return this;
    }

    public Challenge addChallengeMoves(ChallengeMoves challengeMoves) {
        this.challengeMoves.add(challengeMoves);
        challengeMoves.setChallenge(this);
        return this;
    }

    public Challenge removeChallengeMoves(ChallengeMoves challengeMoves) {
        this.challengeMoves.remove(challengeMoves);
        challengeMoves.setChallenge(null);
        return this;
    }
