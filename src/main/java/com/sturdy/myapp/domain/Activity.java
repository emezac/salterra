...
public class Activity implements Serializable {
    ...
    public Activity choices(Set<Choices> choices) {
        this.setChoices(choices);
        return this;
    }

    public Activity addChoices(Choices choices) {
        this.choices.add(choices);
        choices.setActivity(this);
        return this;
    }

    public Activity removeChoices(Choices choices) {
        this.choices.remove(choices);
        choices.setActivity(null);
        return this;
    }
