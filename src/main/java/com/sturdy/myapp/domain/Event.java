...
public class Event implements Serializable {
    ...
    public void setApplicationUsers(Set<ApplicationUser> applicationUsers) {
        if (this.applicationUsers != null) {
            this.applicationUsers.forEach(i -> i.removeEvent(this));
        }
        if (applicationUsers != null) {
            applicationUsers.forEach(i -> i.addEvent(this));
        }
        this.applicationUsers = applicationUsers;
    }

    public Event applicationUsers(Set<ApplicationUser> applicationUsers) {
        this.setApplicationUsers(applicationUsers);
        return this;
    }

    public Event addApplicationUser(ApplicationUser applicationUser) {
        this.applicationUsers.add(applicationUser);
        applicationUser.getEvents().add(this);
        return this;
    }

    public Event removeApplicationUser(ApplicationUser applicationUser) {
