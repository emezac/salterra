...
public class Room implements Serializable {
    ...
    @ManyToMany
    @JoinTable(name = "rel_room__prize", joinColumns = @JoinColumn(name = "room_id"), inverseJoinColumns = @JoinColumn(name = "prize_id"))
