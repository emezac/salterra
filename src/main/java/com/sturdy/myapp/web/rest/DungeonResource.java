...
/**
 * REST controller for managing {@link com.sturdy.myapp.domain.Dungeon}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class DungeonResource {
    ...
    public ResponseEntity<Dungeon> createDungeon(@RequestBody Dungeon dungeon) throws URISyntaxException {
    ...
    public ResponseEntity<Dungeon> updateDungeon(@PathVariable(value = "id", required = false) final Long id, @RequestBody Dungeon dungeon)
