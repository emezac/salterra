...
import com.sturdy.myapp.repository.ApplicationUserRepository;
...
/**
 * REST controller for managing {@link com.sturdy.myapp.domain.ApplicationUser}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<ApplicationUser> partialUpdateApplicationUser(
        ...
        Optional<ApplicationUser> result = applicationUserRepository
            ...
            .map(existingApplicationUser -> {
                if (applicationUser.getFullName() != null) {
                    existingApplicationUser.setFullName(applicationUser.getFullName());
                }
                ...
                if (applicationUser.getPolygonAddress() != null) {
                    existingApplicationUser.setPolygonAddress(applicationUser.getPolygonAddress());
                }
                if (applicationUser.getPublicUrl() != null) {
                    existingApplicationUser.setPublicUrl(applicationUser.getPublicUrl());
                }
