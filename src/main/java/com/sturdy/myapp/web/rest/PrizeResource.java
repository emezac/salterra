...
/**
 * REST controller for managing {@link com.sturdy.myapp.domain.Prize}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class PrizeResource {
    ...
    public ResponseEntity<Prize> updatePrize(@PathVariable(value = "id", required = false) final Long id, @Valid @RequestBody Prize prize)
