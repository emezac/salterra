...
/**
 * REST controller for managing {@link com.sturdy.myapp.domain.Floor}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class FloorResource {
    ...
    public ResponseEntity<Floor> updateFloor(@PathVariable(value = "id", required = false) final Long id, @RequestBody Floor floor)
    ...
    public ResponseEntity<Floor> partialUpdateFloor(@PathVariable(value = "id", required = false) final Long id, @RequestBody Floor floor)
        throws URISyntaxException {
