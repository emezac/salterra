    ...
    public ResponseEntity<FloorRooms> partialUpdateFloorRooms(
        ...
        Optional<FloorRooms> result = floorRoomsRepository
            ...
            .map(existingFloorRooms -> {
                if (floorRooms.getFloorId() != null) {
                    existingFloorRooms.setFloorId(floorRooms.getFloorId());
                }
                if (floorRooms.getRoomId() != null) {
                    existingFloorRooms.setRoomId(floorRooms.getRoomId());
                }
