...
/**
 * REST controller for managing {@link com.sturdy.myapp.domain.Challenge}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Challenge> partialUpdateChallenge(
        ...
        Optional<Challenge> result = challengeRepository
            ...
            .map(existingChallenge -> {
                ...
                if (challenge.getSuccessText() != null) {
                    existingChallenge.setSuccessText(challenge.getSuccessText());
                }
                if (challenge.getFailureText() != null) {
                    existingChallenge.setFailureText(challenge.getFailureText());
                }
                if (challenge.getSkipText() != null) {
                    existingChallenge.setSkipText(challenge.getSkipText());
                }
                ...
                if (challenge.getPrizeNumber() != null) {
                    existingChallenge.setPrizeNumber(challenge.getPrizeNumber());
                }
                if (challenge.getChallangeRating() != null) {
                    existingChallenge.setChallangeRating(challenge.getChallangeRating());
                }
                if (challenge.getSacrificeNumber() != null) {
                    existingChallenge.setSacrificeNumber(challenge.getSacrificeNumber());
                }
                if (challenge.getSkipResult() != null) {
                    existingChallenge.setSkipResult(challenge.getSkipResult());
                }
