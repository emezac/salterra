...
/**
 * REST controller for managing {@link com.sturdy.myapp.domain.Course}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Course> partialUpdateCourse(
        ...
        Optional<Course> result = courseRepository
            ...
            .map(existingCourse -> {
                ...
                if (course.getImageContentType() != null) {
                    existingCourse.setImageContentType(course.getImageContentType());
                }
                if (course.getImageBarCode() != null) {
                    existingCourse.setImageBarCode(course.getImageBarCode());
                }
                if (course.getImageBarCodeContentType() != null) {
                    existingCourse.setImageBarCodeContentType(course.getImageBarCodeContentType());
                }
                if (course.getCertificateImageTemplate() != null) {
                    existingCourse.setCertificateImageTemplate(course.getCertificateImageTemplate());
                }
                if (course.getCertificateImageTemplateContentType() != null) {
                    existingCourse.setCertificateImageTemplateContentType(course.getCertificateImageTemplateContentType());
                }
