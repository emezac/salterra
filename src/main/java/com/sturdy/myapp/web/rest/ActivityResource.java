    ...
    public ResponseEntity<Activity> partialUpdateActivity(
        ...
        Optional<Activity> result = activityRepository
            ...
            .map(existingActivity -> {
                ...
                if (activity.getChallangeDifficulty() != null) {
                    existingActivity.setChallangeDifficulty(activity.getChallangeDifficulty());
                }
                if (activity.getChallengeType() != null) {
                    existingActivity.setChallengeType(activity.getChallengeType());
                }
                if (activity.getFailureResult() != null) {
                    existingActivity.setFailureResult(activity.getFailureResult());
                }
                if (activity.getSuccessResult() != null) {
                    existingActivity.setSuccessResult(activity.getSuccessResult());
                }
                if (activity.getSkipResult() != null) {
                    existingActivity.setSkipResult(activity.getSkipResult());
                }
                if (activity.getsW() != null) {
                    existingActivity.setsW(activity.getsW());
                }
                if (activity.getE() != null) {
                    existingActivity.setE(activity.getE());
                }
                if (activity.getnW() != null) {
                    existingActivity.setnW(activity.getnW());
                }
                if (activity.getN() != null) {
                    existingActivity.setN(activity.getN());
                }
                if (activity.getsE() != null) {
                    existingActivity.setsE(activity.getsE());
                }
                if (activity.getS() != null) {
                    existingActivity.setS(activity.getS());
                }
                if (activity.getnE() != null) {
                    existingActivity.setnE(activity.getnE());
                }
                if (activity.getW() != null) {
                    existingActivity.setW(activity.getW());
                }
