...
public class ChallengeRepositoryWithBagRelationshipsImpl implements ChallengeRepositoryWithBagRelationships {
    ...
    public Optional<Challenge> fetchBagRelationships(Optional<Challenge> challenge) {
        return challenge.map(this::fetchMoves);
    }
    ...
    public List<Challenge> fetchBagRelationships(List<Challenge> challenges) {
        return Optional.of(challenges).map(this::fetchMoves).orElse(Collections.emptyList());
    }

    Challenge fetchMoves(Challenge result) {
        return entityManager
            .createQuery(
                "select challenge from Challenge challenge left join fetch challenge.moves where challenge is :challenge",
                Challenge.class
            )
    ...
    List<Challenge> fetchMoves(List<Challenge> challenges) {
        ...
        List<Challenge> result = entityManager
            .createQuery(
                "select distinct challenge from Challenge challenge left join fetch challenge.moves where challenge in :challenges",
                Challenge.class
            )
