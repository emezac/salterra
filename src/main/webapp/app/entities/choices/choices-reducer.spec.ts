...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './choices.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CHOICES_LIST actions', async () => {
    ...
    it('dispatches FETCH_CHOICES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CHOICES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CHOICES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CHOICES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CHOICES actions', async () => {
      const expectedActions = [
        {
