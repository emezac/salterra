...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DUNGEONFLOORS_LIST actions', async () => {
    ...
    it('dispatches FETCH_DUNGEONFLOORS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DUNGEONFLOORS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DUNGEONFLOORS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DUNGEONFLOORS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DUNGEONFLOORS actions', async () => {
      const expectedActions = [
        {
