        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label="Dg Id" id="dungeon-floors-dgId" name="dgId" data-cy="dgId" type="text" />
              <ValidatedField label="Floor Id" id="dungeon-floors-floorId" name="floorId" data-cy="floorId" type="text" />
