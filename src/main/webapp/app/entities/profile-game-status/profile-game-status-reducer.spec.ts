...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './profile-game-status.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROFILEGAMESTATUS_LIST actions', async () => {
    ...
    it('dispatches FETCH_PROFILEGAMESTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PROFILEGAMESTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PROFILEGAMESTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PROFILEGAMESTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PROFILEGAMESTATUS actions', async () => {
      const expectedActions = [
        {
