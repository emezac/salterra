...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './move.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MOVE_LIST actions', async () => {
    ...
    it('dispatches FETCH_MOVE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MOVE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MOVE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MOVE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MOVE actions', async () => {
      const expectedActions = [
        {
