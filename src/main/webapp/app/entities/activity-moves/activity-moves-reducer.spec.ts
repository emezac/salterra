...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACTIVITYMOVES_LIST actions', async () => {
    ...
    it('dispatches FETCH_ACTIVITYMOVES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ACTIVITYMOVES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ACTIVITYMOVES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ACTIVITYMOVES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ACTIVITYMOVES actions', async () => {
      const expectedActions = [
        {
