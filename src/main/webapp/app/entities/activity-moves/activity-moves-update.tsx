...
import { getEntities as getChoices } from 'app/entities/choices/choices.reducer';
...
export const ActivityMovesUpdate = () => {
  ...
  const choices = useAppSelector(state => state.choices.entities);
  ...
  const saveEntity = values => {
    const entity = {
      ...activityMovesEntity,
      ...values,
      choices: mapIdList(values.choices),
  ...
  const defaultValues = () =>
    isNew
      ...
      : {
          ...activityMovesEntity,
          choices: activityMovesEntity?.choices?.map(e => e.id.toString()),
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label="Choices" id="activity-moves-choices" data-cy="choices" type="select" multiple name="choices">
                <option value="" key="0" />
                {choices
