...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CHALLENGEOPTION_LIST actions', async () => {
    ...
    it('dispatches FETCH_CHALLENGEOPTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CHALLENGEOPTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CHALLENGEOPTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CHALLENGEOPTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CHALLENGEOPTION actions', async () => {
      const expectedActions = [
        {
