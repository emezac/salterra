...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GAMESTATUS_LIST actions', async () => {
    ...
    it('dispatches FETCH_GAMESTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GAMESTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GAMESTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GAMESTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GAMESTATUS actions', async () => {
      const expectedActions = [
        {
