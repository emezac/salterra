...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CHALLENGEMOVES_LIST actions', async () => {
    ...
    it('dispatches FETCH_CHALLENGEMOVES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CHALLENGEMOVES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CHALLENGEMOVES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CHALLENGEMOVES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CHALLENGEMOVES actions', async () => {
      const expectedActions = [
        {
