  ...
  const defaultValues = () =>
    isNew
      ...
      : {
          ...
          difficulty: 'LOW',
          ...challengeEntity,
          moves: challengeEntity?.moves?.map(e => e.id.toString()),
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label="Move" id="challenge-move" data-cy="move" type="select" multiple name="moves">
                <option value="" key="0" />
                {moves
