...
export const ChallengeUpdate = () => {
  ...
  const saveEntity = values => {
    const entity = {
      ...challengeEntity,
      ...values,
      challenges: mapIdList(values.challenges),
  ...
  const defaultValues = () =>
    isNew
      ...
      : {
          ...
          difficulty: 'LOW',
          ...challengeEntity,
          challenges: challengeEntity?.challenges?.map(e => e.id.toString()),
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label="Challenge" id="challenge-challenge" data-cy="challenge" type="select" multiple name="challenges">
                <option value="" key="0" />
                {moves
