        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label="From Id" id="room-connection-fromId" name="fromId" data-cy="fromId" type="text" />
              <ValidatedField label="To Id" id="room-connection-toId" name="toId" data-cy="toId" type="text" />
