...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ROOMCONNECTION_LIST actions', async () => {
    ...
    it('dispatches FETCH_ROOMCONNECTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ROOMCONNECTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ROOMCONNECTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ROOMCONNECTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ROOMCONNECTION actions', async () => {
      const expectedActions = [
        {
