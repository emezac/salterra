...
export const GameResultDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="salterraApp.gameResult.delete.question">Are you sure you want to delete Game Result {gameResultEntity.id}?</ModalBody>
      <ModalFooter>
