            ...
            <tbody>
              {prizeList.map((prize, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{prize.options}</td>
                  <td>{prize.profile ? <Link to={`/profile/${prize.profile.id}`}>{prize.profile.id}</Link> : ''}</td>
                  <td>{prize.card ? <Link to={`/card/${prize.card.id}`}>{prize.card.id}</Link> : ''}</td>
                  <td>{prize.room ? <Link to={`/room/${prize.room.id}`}>{prize.room.id}</Link> : ''}</td>
                  <td>{prize.prizePool ? <Link to={`/prize-pool/${prize.prizePool.id}`}>{prize.prizePool.id}</Link> : ''}</td>
