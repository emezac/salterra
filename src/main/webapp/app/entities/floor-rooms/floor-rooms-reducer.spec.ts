...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FLOORROOMS_LIST actions', async () => {
    ...
    it('dispatches FETCH_FLOORROOMS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FLOORROOMS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FLOORROOMS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FLOORROOMS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FLOORROOMS actions', async () => {
      const expectedActions = [
        {
