...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRIZEPOOL_LIST actions', async () => {
    ...
    it('dispatches FETCH_PRIZEPOOL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PRIZEPOOL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PRIZEPOOL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PRIZEPOOL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PRIZEPOOL actions', async () => {
      const expectedActions = [
        {
