...
export const OptionUpdate = () => {
  ...
  const saveEntity = values => {
    const entity = {
      ...optionEntity,
      ...values,
      option: choices.find(it => it.id.toString() === values.option.toString()),
    };
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField id="option-option" name="option" data-cy="option" label="Option" type="select">
                <option value="" key="0" />
                {choices
